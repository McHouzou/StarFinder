...
plus_UT = -offset / 3600  #Find UTC offset of current location (from machine clock)
...
# plus_UT = 5.0  #in case you want to set local UTC shift by hand
fname_s = "Stars.txt" # "Messier.txt"
fname_c = "Cities.txt"
target_name = "Polaris"
city = "Athens"
country = "Greece"
